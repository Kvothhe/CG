...
int main(int argc, char** argv) {
	...
	cone(2,3, 10, 10, "C:\\Users\\anton\\OneDrive\\Ambiente de Trabalho\\CG\\teste.txt");



	/*
	if (gen.compare("generator") != 0) {

		std::string fig = argv[1];

		if (fig.compare("plane") != 0) {
			...
			//box((Float) arg1,(Float) arg2,(Float) arg3);

		}
		else if (fig.compare("sphere") != 0) {
			...
			//sphere((Float) arg1,(Int) arg2,(Int) arg3);

		}
		else if (fig.compare("cone") != 0) {
			...
			//sphere((Float) arg1,(Float) arg2,(Int) arg3,(Int) arg4);
